...
from Search_based_Planning import Dijkstra as DJjob
...
# **********************************************************************************************************************
    ...
    s_goal = (45, 25)
    # 规划路径
    dijkstrajob = DJjob.Dijkstra(s_start, s_goal, "euclidean")
    plotDijkstra = plotting.Plotting(s_start, s_goal)
    path, visited = dijkstrajob.searching()
    # 绘制路径和访问点
    plotDijkstra.animation(path, visited, "Dijkstra")  # animation
# **********************************************************************************************************************
# --------------------------------------------  处理生成途径点和航向角  ----------------------------------------------------
# **********************************************************************************************************************
    # 反转路径
